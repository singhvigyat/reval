    ...
    <div className="h-full bg-[#F7F8F9] font-['Urbanist'] flex items-center justify-center ">
      <div className="max-w-4xl w-full p-6">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold text-[#1E232C] mb-3">Welcome Teacher!</h1>
          <p className="text-[#6A707C]">Access your re-evaluation dashboard</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white p-8 rounded-[16px] border border-[#DADADA] hover:shadow-lg transition-all hover:border-black">
            <div className="flex flex-col items-center text-center gap-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#1E232C] mb-2">New Teacher</h3>
                <p className="text-[#6A707C] text-sm mb-6">
                  Create a new account to review re-evaluations
                </p>
              </div>
          ...
          <div className="bg-white p-8 rounded-[16px] border border-[#DADADA] hover:shadow-lg transition-all hover:border-black">
            <div className="flex flex-col items-center text-center gap-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#1E232C] mb-2">Existing Teacher</h3>
                <p className="text-[#6A707C] text-sm mb-6">
                  Login to manage re-evaluation requests
                </p>
              </div>
              <Link to="/teacher/login" state={{ organization: orgData || { _id: "demo", orgName: "Demo University" } }} className="w-full">
