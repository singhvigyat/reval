  ...
  return (
    <div className="h-screen flex justify-center items-center font-['Urbanist'] bg-[#F7F8F9]">
      ...
      >
        ...
        >
          Your solution video has been uploaded and is now available for students.
        </motion.p>
        ...
        <div className="flex flex-col w-full gap-4">
          ...
          <motion.button
            ...
            className="w-full h-[50px] border border-black text-black rounded-[8px] px-4 py-2 text-[14px] 
